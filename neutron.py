...
#  print len(set(trainingMolecules))
  ...
  #print 'descriptor List size', len(descriptorList), type(descriptorList)
 ...
 # print zetaTotArray
  ...
  for l in range(0,n):
    for m in range(0,n):
      # include sigma
       K[l,m] =  gaussian(neutronD[l],neutronD[m], sigma_krr)
  ...
  c = np.linalg.solve(K1,moleculesPropertyArray)
 ...
 # print '\n Inversion time: %s sec' % (round(time.time() - start, 1))
  ...
  #print len(descriptorList2)
  #print descriptorList2
 ...
 # print zetaTotArray
  ...
  for l in range(0,n_predict):
    for m in range(0,n):
      # include sigma
       CK[l,m] =  gaussian(neutronD1[l],neutronD[m], sigma_krr)
